...
import static com.project.zipkok.common.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static com.project.zipkok.common.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
