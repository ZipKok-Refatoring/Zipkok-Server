...
public class UserController {
    ...
    @PostMapping("")
    public BaseResponse<AuthTokens> signUp(@Valid @RequestBody PostSignUpRequest postSignUpRequest) {
    ...
    @PatchMapping("")
    public BaseResponse<Object> onBoarding(@Parameter(hidden=true) @PreAuthorize long userId, @Valid @RequestBody PatchOnBoardingRequest patchOnBoardingRequest){
    ...
    public BaseResponse<Object> updateMyInfo(@Parameter(hidden = true) @PreAuthorize long userId, @RequestPart(value = "data", required = false) PutUpdateMyInfoRequest putUpdateMyInfoRequest, @RequestPart(value = "file", required = false) MultipartFile file){
    ...
    public BaseResponse<Object> updateKokOption(@Parameter(hidden=true) @PreAuthorize long userId, @Valid @RequestBody PostUpdateKokOptionRequest postUpdateKokOptionRequest){
    ...
    @PatchMapping("/filter")
    public BaseResponse<Object> updateFilter(@Parameter(hidden=true) @PreAuthorize long userId, @Valid @RequestBody PatchUpdateFilterRequest patchUpdateFilterRequest){
